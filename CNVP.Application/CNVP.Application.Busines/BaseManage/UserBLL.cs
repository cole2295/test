...
using CNVP.Application.IService.BaseManage;
using CNVP.Application.Service.BaseManage;
using CNVP.Cache.Factory;
using CNVP.Util;
using CNVP.Util.Extension;
using CNVP.Util.Offices;
using CNVP.Util.SignalR;
...
namespace CNVP.Application.Busines.BaseManage
{
    /// <summary>
    /// 版 本

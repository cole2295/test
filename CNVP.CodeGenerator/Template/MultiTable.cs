    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace CNVP.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using CNVP.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace CNVP.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using CNVP.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace CNVP.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
            ...
            sb.Append("            {\r\n");
            sb.Append("                //主表\r\n");
            sb.Append("                entity." + multiTableConfigModel.DataBaseTablePK + " =  Guid.NewGuid().ToString();\r\n");
            sb.Append("                entity.Create();\r\n");
            sb.Append("                db.Insert(entity);\r\n");
            sb.Append("                //明细\r\n");
            sb.Append("                foreach (" + multiTableConfigModel.ChildTableName + "Entity item in entryList)\r\n");
            sb.Append("                {\r\n");
            sb.Append("                    item." + multiTableConfigModel.ChildTablePk + " = Guid.NewGuid().ToString();\r\n");
            sb.Append("                    item.Create();\r\n");
            sb.Append("                    item." + multiTableConfigModel.ChildTableForeignkey + " = entity." + multiTableConfigModel.DataBaseTablePK + ";\r\n");
            sb.Append("                    db.Insert(item);\r\n");
            sb.Append("                }\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace CNVP.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using CNVP.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace CNVP.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using CNVP.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Util;\r\n");
            sb.Append("using CNVP.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace CNVP.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");

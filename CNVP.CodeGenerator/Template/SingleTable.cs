using CNVP.CodeGenerator.Comm;
using CNVP.CodeGenerator.Model;
using CNVP.Util;
using System;
...
namespace CNVP.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 6.1
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("using CNVP.Application.Code;\r\n\r\n");

            sb.Append("namespace CNVP.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using CNVP.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace CNVP.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using CNVP.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Data.Repository;\r\n");
            sb.Append("using CNVP.Util.WebControl;\r\n");
            ...
            sb.Append("namespace CNVP.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
            ...
            sb.Append("        #region 其他\r\n");
            sb.Append("        public DataTable FindTable(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("        return BaseRepository().FindTable(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public DataTable FindTable(string strSql, Pagination pagination)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().FindTable(strSql, pagination);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public DataTable FindTable(string strSql, DbParameter[] dbParameter)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().FindTable(strSql, dbParameter);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public DataTable FindTable(string strSql, DbParameter[] dbParameter, Pagination pagination)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().FindTable(strSql, dbParameter, pagination);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public object FindObject(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().FindObject(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public object FindObject(string strSql, DbParameter[] dbParameter)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().FindObject(strSql, dbParameter);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public int ExecuteBySql(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().ExecuteBySql(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public int ExecuteBySql(string strSql, params DbParameter[] dbParameter)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().ExecuteBySql(strSql, dbParameter);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public IQueryable< " + baseConfigModel.EntityClassName + "> IQueryable(Expression<Func< " + baseConfigModel.EntityClassName + ", bool>> condition)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return BaseRepository().IQueryable(condition);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public IEnumerable< " + baseConfigModel.EntityClassName + "> FindList(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return this.BaseRepository().FindList(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public IEnumerable< " + baseConfigModel.EntityClassName + "> FindList(string strSql, Pagination pagination)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return this.BaseRepository().FindList(strSql, pagination);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        #endregion\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace CNVP.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
            ...
            sb.Append("        #region 其他\r\n");
            sb.Append("        DataTable FindTable(string strSql);\r\n");
            sb.Append("        DataTable FindTable(string strSql, Pagination pagination);\r\n");
            sb.Append("        DataTable FindTable(string strSql, DbParameter[] dbParameter);\r\n");
            sb.Append("        DataTable FindTable(string strSql, DbParameter[] dbParameter, Pagination pagination);\r\n");
            sb.Append("        object FindObject(string strSql);\r\n");
            sb.Append("        object FindObject(string strSql, DbParameter[] dbParameter);\r\n");
            sb.Append("        int ExecuteBySql(string strSql);\r\n");
            sb.Append("        int ExecuteBySql(string strSql, params DbParameter[] dbParameter);\r\n");
            sb.Append("        IQueryable<" + baseConfigModel.EntityClassName + "> IQueryable(Expression<Func<" + baseConfigModel.EntityClassName + ", bool>> condition);\r\n");
            sb.Append("        IEnumerable<" + baseConfigModel.EntityClassName + "> FindList(string strSql);\r\n");
            sb.Append("        IEnumerable<" + baseConfigModel.EntityClassName + "> FindList(string strSql, Pagination pagination);\r\n");
            sb.Append("        #endregion\r\n");
            sb.Append("    }\r\n");
            sb.Append("}\r\n");
            return sb.ToString();
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using CNVP.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Data;\r\n");
            ...
            sb.Append("namespace CNVP.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
            ...
            sb.Append("        public DataTable FindTable(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindTable(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public DataTable FindTable(string strSql, Pagination pagination)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindTable(strSql, pagination);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public DataTable FindTable(string strSql, DbParameter[] dbParameter)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindTable(strSql, dbParameter);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public DataTable FindTable(string strSql, DbParameter[] dbParameter, Pagination pagination)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindTable(strSql, dbParameter, pagination);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public object FindObject(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindObject(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public object FindObject(string strSql, DbParameter[] dbParameter)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindObject(strSql, dbParameter);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public int ExecuteBySql(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.ExecuteBySql(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public int ExecuteBySql(string strSql, params DbParameter[] dbParameter)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.ExecuteBySql(strSql, dbParameter);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public IQueryable<" + baseConfigModel.EntityClassName + "> IQueryable(Expression<Func<" + baseConfigModel.EntityClassName + ", bool>> condition)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.IQueryable(condition);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public IEnumerable<" + baseConfigModel.EntityClassName + "> FindList(string strSql)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindList(strSql);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        public IEnumerable<" + baseConfigModel.EntityClassName + "> FindList(string strSql, Pagination pagination)\r\n");
            sb.Append("        {\r\n");
            sb.Append("            return service.FindList(strSql, pagination);\r\n");
            sb.Append("        }\r\n\r\n");
            sb.Append("        #endregion\r\n");
            sb.Append("    }\r\n");
            sb.Append("}\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using CNVP.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using CNVP.Util;\r\n");
            sb.Append("using CNVP.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace CNVP.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// Copyright (c) 2013-2016 温州市捷点信息技术有限公司\r\n");
        ...
        public string IndexBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("                selectedRowIndex = $gridTable.getGridParam('selrow');\r\n");
            sb.Append("            },\r\n");
            sb.Append("            gridComplete: function () {\r\n");
            sb.Append("                $gridTable.setSelection(selectedRowIndex, false);\r\n");
            sb.Append("            }\r\n");
            sb.Append("        });\r\n");
            sb.Append("    }\r\n");
            sb.Append("    //新增\r\n");
